...
<style>
tr:nth-child(even) {background-color: #f2f292}
th {
...
<?php
			...
			$sql = "INSERT INTO Ebill VALUES ('$consumer_number',
							'$lconsumer_name','$previous_readingr','$present_reading','$Unit_consumed','$Amount')";
